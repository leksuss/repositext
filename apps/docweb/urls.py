...
urlpatterns = [
    ...
    path('repository/folder/<uuid:folder_id>/', login_required(RepositoryView.as_view()), name="repo-view"),
    path('repository/folder/<uuid:folder_id>/document/add/', login_required(AddDocumentView.as_view()), name="add-document-view"),
